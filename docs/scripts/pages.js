var pages = [{'name': 'colorize', 'index': '0', 'disabled': true, 'searchKey': 'colorize'},
    {
        'name': 'fun String.colorize(): String',
        'level': 1,
        'index': '0.0',
        'description': 'dev.jaims.mcutils.bungee.colorize',
        'location': 'project/dev.jaims.mcutils.bungee/colorize.html',
        'searchKey': 'colorize'
    },
    {
        'name': 'fun String.colorize(player: Player?): String',
        'level': 1,
        'index': '0.1',
        'description': 'dev.jaims.mcutils.bukkit.colorize',
        'location': 'project/dev.jaims.mcutils.bukkit/colorize.html',
        'searchKey': 'colorize'
    },
    {'name': 'log', 'index': '1', 'disabled': true, 'searchKey': 'log'},
    {
        'name': 'fun Plugin.log(message: String, severity: Severity)',
        'level': 1,
        'index': '1.0',
    ...
    {
        'name': 'fun Player.inRadiusOfLocation(location: Location, radius: Int): Boolean',
        'index': '2',
    ...
    },
    {
        ...
        'index': '5',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/index.html',
    ...
    },
    {
        ...
        'index': '7',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.addItemFlag',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/add-item-flag.html',
    ...
    },
    {
        ...
        'index': '8',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.<init>',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/-init-.html',
        'searchKey': '<init>'
    },
    {
    ...
    },
    {
        ...
        'index': '10',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.setName',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/set-name.html',
        'searchKey': 'setName'
    },
    {
    ...
    },
    {
        ...
        'index': '12',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.setAmount',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/set-amount.html',
        'searchKey': 'setAmount'
    },
    {
        'name': 'open override fun get(): ItemStack',
        'index': '13',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.get',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/get.html',
        'searchKey': 'get'
    },
    {
        'name': 'fun addEnchantment(newenchantment: Enchantment, level: Int): ItemBuilder',
        'index': '14',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.addEnchantment',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/add-enchantment.html',
        'searchKey': 'addEnchantment'
    },
    {
        'name': 'fun setGlow(newglow: Boolean): ItemBuilder',
        'index': '15',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.setGlow',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/set-glow.html',
        'searchKey': 'setGlow'
    },
    {
    ...
    },
    {
        ...
        'index': '18',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.addEnchantments',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/add-enchantments.html',
        'searchKey': 'addEnchantments'
    },
    {
        'name': 'fun setDamage(newdamage: Int): ItemBuilder',
        'index': '19',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.setDamage',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/set-damage.html',
        'searchKey': 'setDamage'
    },
    {
        'name': 'fun setUnbreakable(newunbreakable: Boolean): ItemBuilder',
        'index': '20',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.setUnbreakable',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/set-unbreakable.html',
        'searchKey': 'setUnbreakable'
    },
    {
        'name': 'fun addItemFlags(newitemflags: List<ItemFlag>): ItemBuilder',
        'index': '21',
        'description': 'dev.jaims.mcutils.bukkit.ItemBuilder.addItemFlags',
        'location': 'project/dev.jaims.mcutils.bukkit/-item-builder/add-item-flags.html',
